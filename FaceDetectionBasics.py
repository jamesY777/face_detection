...
face = mpFace.FaceDetection() #Face object
...
while True:
    ...
    results = face.process(imgRGB) #Detect the face object from the 

    if results.detections: #If face is detected in the video
        for id, detection in enumerate(results.detections):
            #mpDraw.draw_detection(img, detection) # Draw default face box using mpDraw
            # print(id, detection)
